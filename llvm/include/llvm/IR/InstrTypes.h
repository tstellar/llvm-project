...
class LLVM_ABI UnaryInstruction : public Instruction {
protected:
...
template <>
struct LLVM_ABI OperandTraits<UnaryInstruction> :
...
template <>
struct LLVM_ABI OperandTraits<BinaryOperator> :
...
template <>
struct LLVM_ABI OperandTraits<CmpInst> : public FixedNumOperandTraits<CmpInst, 2> {
};
...
/// around by value.
struct LLVM_ABI OperandBundleUse {
  ArrayRef<Use> Inputs;
...
template <typename InputTy> class LLVM_ABI OperandBundleDefT {
  std::string Tag;
...
template <>
struct LLVM_ABI OperandTraits<CallBase> : public VariadicOperandTraits<CallBase, 1> {};
...
template <>
struct LLVM_ABI OperandTraits<FuncletPadInst>
