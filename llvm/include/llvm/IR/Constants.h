...
class LLVM_ABI ConstantData : public Constant {
...
template <>
struct LLVM_ABI OperandTraits<ConstantAggregate>
...
template <>
struct LLVM_ABI OperandTraits<BlockAddress>
...
template <>
struct LLVM_ABI OperandTraits<DSOLocalEquivalent>
...
template <>
struct LLVM_ABI OperandTraits<NoCFIValue> : public FixedNumOperandTraits<NoCFIValue, 1> {
};
...
template <>
struct LLVM_ABI OperandTraits<ConstantExpr>
