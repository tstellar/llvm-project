...
template <typename NodeTy> struct LLVM_ABI SymbolTableListParentType {};
...
class LLVM_ABI SymbolTableListTraits : public ilist_alloc_traits<ValueSubClass> {
...
template <class T>
class LLVM_ABI SymbolTableList
