...
struct LLVM_ABI alignas(8) GlobalValueSummaryInfo {
  union NameOrGV {
...
template <> struct LLVM_ABI DenseMapInfo<ValueInfo> {
...
class LLVM_ABI GlobalValueSummary {
public:
...
class LLVM_ABI AliasSummary : public GlobalValueSummary {
...
template <> struct LLVM_ABI DenseMapInfo<FunctionSummary::VFuncId> {
...
template <> struct LLVM_ABI DenseMapInfo<FunctionSummary::ConstVCall> {
...
/// initializer array.
struct LLVM_ABI VirtFuncOffset {
...
class LLVM_ABI GlobalVarSummary : public GlobalValueSummary {
private:
...
struct LLVM_ABI TypeTestResolution {
...
struct LLVM_ABI WholeProgramDevirtResolution {
  enum Kind {
...
struct LLVM_ABI TypeIdOffsetVtableInfo {
...
template <> struct LLVM_ABI GraphTraits<ValueInfo> {
...
template <>
struct LLVM_ABI GraphTraits<ModuleSummaryIndex *> : public GraphTraits<ValueInfo> {
