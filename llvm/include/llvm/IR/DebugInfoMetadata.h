...
class LLVM_ABI DITemplateParameter : public DINode {
protected:
  bool IsDefault;
...
template <> struct LLVM_ABI DenseMapInfo<DIExpression::FragmentInfo> {
...
class LLVM_ABI DIMacroNode : public MDNode {
  friend class LLVMContextImpl;
  friend class MDNode;
...
/// intrinsic.
class LLVM_ABI DIArgList : public MDNode {
  friend class LLVMContextImpl;
  friend class MDNode;
...
template <> struct LLVM_ABI DenseMapInfo<DebugVariable> {
  using FragmentInfo = DIExpression::FragmentInfo;
...
template <>
struct LLVM_ABI DenseMapInfo<DebugVariableAggregate>
