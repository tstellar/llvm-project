...
struct LLVM_ABI ValueDeleter { void operator()(Value *V) { V->deleteValue(); } };
...
//
template <> struct LLVM_ABI isa_impl<Constant, Value> {
...
template <> struct LLVM_ABI isa_impl<ConstantData, Value> {
  static inline bool doit(const Value &Val) {
...
template <> struct LLVM_ABI isa_impl<ConstantAggregate, Value> {
  static inline bool doit(const Value &Val) {
...
template <> struct LLVM_ABI isa_impl<Argument, Value> {
  static inline bool doit (const Value &Val) {
    return Val.getValueID() == Value::ArgumentVal;
  }
};

template <> struct LLVM_ABI isa_impl<InlineAsm, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::InlineAsmVal;
  }
};

template <> struct LLVM_ABI isa_impl<Instruction, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() >= Value::InstructionVal;
  }
};

template <> struct LLVM_ABI isa_impl<BasicBlock, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::BasicBlockVal;
  }
};

template <> struct LLVM_ABI isa_impl<Function, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::FunctionVal;
  }
};

template <> struct LLVM_ABI isa_impl<GlobalVariable, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::GlobalVariableVal;
  }
};

template <> struct LLVM_ABI isa_impl<GlobalAlias, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::GlobalAliasVal;
  }
};

template <> struct LLVM_ABI isa_impl<GlobalIFunc, Value> {
  static inline bool doit(const Value &Val) {
    return Val.getValueID() == Value::GlobalIFuncVal;
  }
};

template <> struct LLVM_ABI isa_impl<GlobalValue, Value> {
  static inline bool doit(const Value &Val) {
    return isa<GlobalObject>(Val) || isa<GlobalAlias>(Val);
  }
};

template <> struct LLVM_ABI isa_impl<GlobalObject, Value> {
  static inline bool doit(const Value &Val) {
