...
class LLVM_ABI HWInstructionEvent {
public:
...
class LLVM_ABI HWInstructionIssuedEvent : public HWInstructionEvent {
public:
...
class LLVM_ABI HWInstructionDispatchedEvent : public HWInstructionEvent {
public:
...
class LLVM_ABI HWInstructionRetiredEvent : public HWInstructionEvent {
public:
...
class LLVM_ABI HWPressureEvent {
public:
  enum GenericReason {
    INVALID = 0,
