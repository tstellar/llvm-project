...
class LLVM_ABI df_iterator_storage {
public:
  SetType Visited;
};

template<class SetType>
class LLVM_ABI df_iterator_storage<SetType, true> {
public:
...
struct LLVM_ABI df_iterator_default_set : public SmallPtrSet<NodeRef, SmallSize> {
...
class LLVM_ABI df_iterator : public df_iterator_storage<SetType, ExtStorage> {
public:
...
struct LLVM_ABI df_ext_iterator : public df_iterator<T, SetTy, true> {
...
template <class T,
          ...
          bool External = false>
struct LLVM_ABI idf_iterator : public df_iterator<Inverse<T>, SetTy, External> {
...
template <class T, class SetTy = df_iterator_default_set<typename GraphTraits<T>::NodeRef>>
struct LLVM_ABI idf_ext_iterator : public idf_iterator<T, SetTy, true> {
