...
class LLVM_ABI PackedVectorBase<T, BitNum, BitVectorTy, false> {
protected:
...
template <typename T, unsigned BitNum, typename BitVectorTy>
class LLVM_ABI PackedVectorBase<T, BitNum, BitVectorTy, true> {
protected:
  static T getValue(const BitVectorTy &Bits, unsigned Idx) {
    T val = T();
...
class LLVM_ABI PackedVector : public PackedVectorBase<T, BitNum, BitVectorTy,
