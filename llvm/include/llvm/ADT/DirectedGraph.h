...
template <class NodeType, class EdgeType> class LLVM_ABI DGEdge {
public:
  DGEdge() = delete;
...
template <class NodeType, class EdgeType> class LLVM_ABI DGNode {
public:
...
template <class NodeType, class EdgeType> class LLVM_ABI DirectedGraph {
protected:
