...
// Information by Name
LLVM_ABI std::optional<ArchInfo> getArchForCpu(StringRef CPU);

// Parser
LLVM_ABI std::optional<ArchInfo> parseArch(StringRef Arch);
