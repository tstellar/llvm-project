...
struct LLVM_ABI SectionRename {
  StringRef OriginalName;
  StringRef NewName;
  std::optional<SectionFlag> NewFlags;
};

struct LLVM_ABI SectionFlagsUpdate {
  StringRef Name;
...
struct LLVM_ABI NewSectionInfo {
