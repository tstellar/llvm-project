...
struct LLVM_ABI PubIndexEntryDescriptor {
...
template <typename Enum> struct LLVM_ABI EnumTraits : public std::false_type {};

template <> struct LLVM_ABI EnumTraits<Attribute> : public std::true_type {
  static constexpr char Type[3] = "AT";
  static constexpr StringRef (*StringFn)(unsigned) = &AttributeString;
};

template <> struct LLVM_ABI EnumTraits<Form> : public std::true_type {
  static constexpr char Type[5] = "FORM";
  static constexpr StringRef (*StringFn)(unsigned) = &FormEncodingString;
};

template <> struct LLVM_ABI EnumTraits<Index> : public std::true_type {
  static constexpr char Type[4] = "IDX";
  static constexpr StringRef (*StringFn)(unsigned) = &IndexString;
};

template <> struct LLVM_ABI EnumTraits<Tag> : public std::true_type {
  static constexpr char Type[4] = "TAG";
  static constexpr StringRef (*StringFn)(unsigned) = &TagString;
};

template <> struct LLVM_ABI EnumTraits<LineNumberOps> : public std::true_type {
  static constexpr char Type[4] = "LNS";
  static constexpr StringRef (*StringFn)(unsigned) = &LNStandardString;
};

template <> struct LLVM_ABI EnumTraits<LocationAtom> : public std::true_type {
...
struct LLVM_ABI format_provider<Enum, std::enable_if_t<dwarf::EnumTraits<Enum>::value>> {
