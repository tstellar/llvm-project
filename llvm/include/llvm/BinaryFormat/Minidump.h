...
struct LLVM_ABI LocationDescriptor {
...
struct LLVM_ABI VSFixedFileInfo {
  support::ulittle32_t Signature;
...
struct LLVM_ABI ExceptionStream {
  support::ulittle32_t ThreadId;
  support::ulittle32_t UnusedAlignment;
...
template <> struct LLVM_ABI DenseMapInfo<minidump::StreamType> {
