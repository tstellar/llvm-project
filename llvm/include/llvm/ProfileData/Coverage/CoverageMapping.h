...
/// with two counters.
struct LLVM_ABI CounterExpression {
...
struct LLVM_ABI CounterMappingRegion {
  enum RegionKind {
...
struct LLVM_ABI CountedRegion : public CounterMappingRegion {
...
struct LLVM_ABI FunctionRecord {
  /// Raw function name.
  std::string Name;
...
struct LLVM_ABI ExpansionRecord {
...
struct LLVM_ABI CoverageSegment {
...
class LLVM_ABI InstantiationGroup {
...
struct LLVM_ABI CovMapFunctionRecordV1 {
...
struct LLVM_ABI CovMapFunctionRecordV2 {
...
struct LLVM_ABI CovMapFunctionRecordV3 {
...
template <int CovMapVersion, class IntPtrT> struct LLVM_ABI CovMapTraits {
  using CovMapFuncRecordType = CovMapFunctionRecordV3;
  using NameRefType = uint64_t;
};

template <class IntPtrT> struct LLVM_ABI CovMapTraits<CovMapVersion::Version3, IntPtrT> {
  using CovMapFuncRecordType = CovMapFunctionRecordV2;
  using NameRefType = uint64_t;
};

template <class IntPtrT> struct LLVM_ABI CovMapTraits<CovMapVersion::Version2, IntPtrT> {
  using CovMapFuncRecordType = CovMapFunctionRecordV2;
  using NameRefType = uint64_t;
};

template <class IntPtrT> struct LLVM_ABI CovMapTraits<CovMapVersion::Version1, IntPtrT> {
...
template<> struct LLVM_ABI DenseMapInfo<coverage::CounterExpression> {
