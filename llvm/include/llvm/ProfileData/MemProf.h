...
// deserialize methods.
struct LLVM_ABI PortableMemInfoBlock {
...
struct LLVM_ABI AllocationInfo {
...
class LLVM_ABI RecordLookupTrait {
public:
...
class LLVM_ABI RecordWriterTrait {
public:
...
class LLVM_ABI FrameWriterTrait {
public:
...
class LLVM_ABI FrameLookupTrait {
public:
