...
struct LLVM_ABI ParserCallbacks {
  ...
  struct LLVM_ABI BitcodeLTOInfo {
    bool IsThinLTO;
    bool HasSummary;
  ...
  struct LLVM_ABI BitcodeFileContents {
...
template <> struct LLVM_ABI is_error_code_enum<llvm::BitcodeError> : std::true_type {};
