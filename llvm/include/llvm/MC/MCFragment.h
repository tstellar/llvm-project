...
class LLVM_ABI MCDummyFragment : public MCFragment {
public:
...
/// data.
///
class LLVM_ABI MCEncodedFragment : public MCFragment {
...
class LLVM_ABI MCEncodedFragmentWithContents : public MCEncodedFragment {
...
class LLVM_ABI MCEncodedFragmentWithFixups :
...
///
class LLVM_ABI MCDataFragment : public MCEncodedFragmentWithFixups<32, 4> {
public:
...
/// consumption.
///
class LLVM_ABI MCCompactEncodedInstFragment : public MCEncodedFragmentWithContents<4> {
public:
...
///
class LLVM_ABI MCRelaxableFragment : public MCEncodedFragmentWithFixups<8, 1> {
...
class LLVM_ABI MCAlignFragment : public MCFragment {
...
class LLVM_ABI MCFillFragment : public MCFragment {
  uint8_t ValueSize;
...
class LLVM_ABI MCNopsFragment : public MCFragment {
  /// The number of bytes to insert.
  int64_t Size;
...
class LLVM_ABI MCOrgFragment : public MCFragment {
  /// Value to use for filling bytes.
  int8_t Value;
...
class LLVM_ABI MCLEBFragment : public MCFragment {
...
class LLVM_ABI MCDwarfLineAddrFragment : public MCEncodedFragmentWithFixups<8, 1> {
...
class LLVM_ABI MCDwarfCallFrameFragment : public MCEncodedFragmentWithFixups<8, 1> {
  /// The expression for the difference of the two symbols that
...
class LLVM_ABI MCSymbolIdFragment : public MCFragment {
  const MCSymbol *Sym;
...
class LLVM_ABI MCCVInlineLineTableFragment : public MCFragment {
  unsigned SiteFuncId;
...
class LLVM_ABI MCCVDefRangeFragment : public MCEncodedFragmentWithFixups<32, 4> {
...
class LLVM_ABI MCBoundaryAlignFragment : public MCFragment {
...
class LLVM_ABI MCPseudoProbeAddrFragment : public MCEncodedFragmentWithFixups<8, 1> {
  /// The expression for the difference of the two symbols that
