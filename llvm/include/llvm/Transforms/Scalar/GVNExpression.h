...
class LLVM_ABI MemoryExpression : public BasicExpression {
private:
...
class LLVM_ABI int_op_inserter {
private:
...
class LLVM_ABI DeadExpression final : public Expression {
public:
...
class LLVM_ABI VariableExpression final : public Expression {
private:
  Value *VariableValue;
...
class LLVM_ABI ConstantExpression final : public Expression {
private:
...
class LLVM_ABI UnknownExpression final : public Expression {
private:
  Instruction *Inst;
