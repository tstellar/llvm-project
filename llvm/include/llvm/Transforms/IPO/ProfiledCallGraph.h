...
struct LLVM_ABI ProfiledCallGraphEdge {
...
struct LLVM_ABI ProfiledCallGraphNode {
...
class LLVM_ABI ProfiledCallGraph {
public:
...
template <> struct LLVM_ABI GraphTraits<ProfiledCallGraphNode *> {
...
template <>
struct LLVM_ABI GraphTraits<ProfiledCallGraph *>
