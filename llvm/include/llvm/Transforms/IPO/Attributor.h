...
struct LLVM_ABI ValueAndContext : public std::pair<Value *, const Instruction *> {
...
LLVM_ABI Constant *getInitialValueForObj(Attributor &A, Value &Obj, Type &Ty,
...
template <>
struct LLVM_ABI DenseMapInfo<AA::ValueAndContext>
...
template <>
struct LLVM_ABI DenseMapInfo<AA::ValueScope> : public DenseMapInfo<unsigned char> {
...
template <>
struct LLVM_ABI DenseMapInfo<const AA::InstExclusionSetTy *>
...
struct LLVM_ABI AADepGraphNode {
public:
...
template <> struct LLVM_ABI DenseMapInfo<IRPosition> {
...
struct LLVM_ABI AnalysisGetter {
...
struct LLVM_ABI AttributorConfig {
...
struct LLVM_ABI IntegerStateBase : public AbstractState {
...
struct LLVM_ABI BitIntegerState
...
template <typename base_ty = uint32_t, base_ty BestState = ~base_ty(0),
          base_ty WorstState = 0>
struct LLVM_ABI IncIntegerState
    : public IntegerStateBase<base_ty, BestState, WorstState> {
  using super = IntegerStateBase<base_ty, BestState, WorstState>;
  using base_t = base_ty;
...
struct LLVM_ABI DecIntegerState : public IntegerStateBase<base_ty, 0, ~base_ty(0)> {
  using base_t = base_ty;
...
struct LLVM_ABI BooleanState : public IntegerStateBase<bool, true, false> {
...
struct LLVM_ABI IntegerRangeState : public AbstractState {
...
template <typename BaseTy> struct LLVM_ABI SetState : public AbstractState {
...
struct LLVM_ABI StateWrapper : public BaseType, public StateTy {
...
struct LLVM_ABI IRAttribute : public BaseType {
...
struct LLVM_ABI AAReturnedValues
...
struct LLVM_ABI DerefState : AbstractState {
...
template <typename MemberTy> struct LLVM_ABI PotentialValuesState : AbstractState {
...
struct LLVM_ABI AAPotentialConstantValues
...
template <> struct LLVM_ABI GraphTraits<AACallGraphNode *> {
...
template <>
struct LLVM_ABI GraphTraits<AttributorCallGraph *>
...
template <>
struct LLVM_ABI DOTGraphTraits<AttributorCallGraph *> : public DefaultDOTGraphTraits {
