...
struct LLVM_ABI CriticalEdgeSplittingOptions {
  DominatorTree *DT;
...
LLVM_ABI BasicBlock *SplitBlock(BasicBlock *Old, Instruction *SplitPt, DominatorTree *DT,
                       LoopInfo *LI = nullptr,
                       MemorySSAUpdater *MSSAU = nullptr,
...
/// SplitPt moves to a new block. The two blocks are joined by an unconditional
/// branch. The new block with name \p BBName is returned.
LLVM_ABI BasicBlock *SplitBlock(BasicBlock *Old, Instruction *SplitPt,
                       DomTreeUpdater *DTU = nullptr, LoopInfo *LI = nullptr,
                       MemorySSAUpdater *MSSAU = nullptr,
                       const Twine &BBName = "", bool Before = false);
...
LLVM_ABI BasicBlock *splitBlockBefore(BasicBlock *Old, Instruction *SplitPt,
...
///
/// FIXME: deprecated, switch to the DomTreeUpdater-based one.
LLVM_ABI void SplitLandingPadPredecessors(BasicBlock *OrigBB,
...
LLVM_ABI Instruction *SplitBlockAndInsertIfThen(Value *Cond, Instruction *SplitBefore,
                                       bool Unreachable,
...
///
/// Updates DT if given.
LLVM_ABI void SplitBlockAndInsertIfThenElse(Value *Cond, Instruction *SplitBefore,
