...
LLVM_ABI Value *createSelectCmpOp(IRBuilderBase &Builder, Value *StartVal, RecurKind RK,
...
/// Fast-math-flags are propagated using the IRBuilder's setting.
LLVM_ABI Value *createSimpleTargetReduction(IRBuilderBase &B,
...
LLVM_ABI Value *createSelectCmpTargetReduction(IRBuilderBase &B,
...
LLVM_ABI Value *createTargetReduction(IRBuilderBase &B, const TargetTransformInfo *TTI,
...
struct LLVM_ABI IVConditionInfo {
