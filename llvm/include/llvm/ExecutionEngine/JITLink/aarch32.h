...
LLVM_FUNC_ABI uint32_t encodeRegMovtA1MovwA2(int64_t Value);
LLVM_FUNC_ABI int64_t decodeImmBA1BlA1BlxA2(int64_t Value);
LLVM_FUNC_ABI uint32_t encodeImmBA1BlA1BlxA2(int64_t Value);
