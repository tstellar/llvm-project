...
class LLVM_ABI SPSOutputBuffer {
public:
...
template <> class LLVM_ABI SPSArgList<> {
public:
...
class LLVM_ABI SPSArgList<SPSTagT, SPSTagTs...> {
public:
...
class LLVM_ABI SPSSerializationTraits<
    SPSTagT, SPSTagT,
...
/// after it.
template <typename SPSTagT> class LLVM_ABI SPSOptional {};
...
template <> class LLVM_ABI SPSSerializationTraits<SPSEmpty, SPSEmpty> {
public:
...
class LLVM_ABI TrivialSPSSequenceSerialization {
public:
...
/// specialization of SPSSerializationTraits for your type.
template <typename SPSElementTagT, typename ConcreteSequenceT>
class LLVM_ABI TrivialSPSSequenceDeserialization {
public:
  static constexpr bool available = false;
};

/// Trivial std::string -> SPSSequence<char> serialization.
template <> class LLVM_ABI TrivialSPSSequenceSerialization<char, std::string> {
public:
  static constexpr bool available = true;
};

/// Trivial SPSSequence<char> -> std::string deserialization.
template <> class LLVM_ABI TrivialSPSSequenceDeserialization<char, std::string> {
public:
  static constexpr bool available = true;
...
class LLVM_ABI TrivialSPSSequenceSerialization<SPSElementTagT, std::vector<T>> {
public:
  static constexpr bool available = true;
};
...
template <typename SPSElementTagT, typename T>
class LLVM_ABI TrivialSPSSequenceDeserialization<SPSElementTagT, std::vector<T>> {
public:
  static constexpr bool available = true;
...
template <typename SPSElementTagT, typename T>
class LLVM_ABI TrivialSPSSequenceSerialization<SPSElementTagT, SmallVectorImpl<T>> {
public:
  static constexpr bool available = true;
};
...
template <typename SPSElementTagT, typename T>
class LLVM_ABI TrivialSPSSequenceDeserialization<SPSElementTagT, SmallVectorImpl<T>> {
public:
  static constexpr bool available = true;
...
class LLVM_ABI TrivialSPSSequenceSerialization<SPSElementTagT, SmallVector<T, N>>
    : public TrivialSPSSequenceSerialization<SPSElementTagT,
                                             SmallVectorImpl<T>> {};

/// Trivial SPSSequence<SPSElementTagT> -> SmallVectorImpl<T> deserialization.
template <typename SPSElementTagT, typename T, unsigned N>
class LLVM_ABI TrivialSPSSequenceDeserialization<SPSElementTagT, SmallVector<T, N>>
    : public TrivialSPSSequenceDeserialization<SPSElementTagT,
                                               SmallVectorImpl<T>> {};

/// Trivial ArrayRef<T> -> SPSSequence<SPSElementTagT> serialization.
template <typename SPSElementTagT, typename T>
class LLVM_ABI TrivialSPSSequenceSerialization<SPSElementTagT, ArrayRef<T>> {
public:
  static constexpr bool available = true;
};
...
template <> class LLVM_ABI SPSSerializationTraits<SPSSequence<char>, ArrayRef<char>> {
public:
...
class LLVM_ABI SPSSerializationTraits<SPSSequence<SPSElementTagT>, SequenceT,
...
class LLVM_ABI SPSSerializationTraits<SPSTuple<SPSTagTs...>, std::tuple<Ts...>> {
private:
...
class LLVM_ABI SPSSerializationTraits<SPSTuple<SPSTagT1, SPSTagT2>, std::pair<T1, T2>> {
public:
...
class LLVM_ABI SPSSerializationTraits<SPSOptional<SPSTagT>, std::optional<T>> {
public:
...
/// into the blob.
template <> class LLVM_ABI SPSSerializationTraits<SPSString, StringRef> {
public:
...
class LLVM_ABI SPSSerializationTraits<SPSSequence<SPSTuple<SPSString, SPSValueT>>,
                             StringMap<ValueT>> {
public:
...
struct LLVM_ABI SPSSerializableError {
  bool HasError = false;
  std::string ErrMsg;
};
...
template <typename T> struct LLVM_ABI SPSSerializableExpected {
  bool HasValue = false;
  T Value{};
  std::string ErrMsg;
};
...
template <>
class LLVM_ABI SPSSerializationTraits<SPSError, detail::SPSSerializableError> {
public:
...
template <typename SPSTagT, typename T>
class LLVM_ABI SPSSerializationTraits<SPSExpected<SPSTagT>,
                             detail::SPSSerializableExpected<T>> {
public:
...
template <typename SPSTagT, typename T>
class LLVM_ABI SPSSerializationTraits<SPSExpected<SPSTagT>, T> {
public:
