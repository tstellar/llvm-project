...
struct LLVM_ABI AttributeAbbrev {
...
struct LLVM_ABI AbbrevTable {
  std::optional<uint64_t> ID;
  std::vector<Abbrev> Table;
};

struct LLVM_ABI ARangeDescriptor {
  llvm::yaml::Hex64 Address;
  yaml::Hex64 Length;
};

struct LLVM_ABI ARange {
...
struct LLVM_ABI FormValue {
  llvm::yaml::Hex64 Value;
  StringRef CStr;
  std::vector<llvm::yaml::Hex8> BlockData;
};

struct LLVM_ABI Entry {
...
/// data structures.
struct LLVM_ABI DWARFContext {
  bool IsGNUPubSec = false;
};

struct LLVM_ABI Unit {
  dwarf::DwarfFormat Format;
  std::optional<yaml::Hex64> Length;
  uint16_t Version;
...
struct LLVM_ABI LineTableOpcode {
...
struct LLVM_ABI SegAddrPair {
  yaml::Hex64 Segment;
  yaml::Hex64 Address;
};

struct LLVM_ABI AddrTableEntry {
  dwarf::DwarfFormat Format;
  std::optional<yaml::Hex64> Length;
  yaml::Hex16 Version;
  std::optional<yaml::Hex8> AddrSize;
...
struct LLVM_ABI StringOffsetsTable {
  dwarf::DwarfFormat Format;
  std::optional<yaml::Hex64> Length;
  yaml::Hex16 Version;
  yaml::Hex16 Padding;
...
struct LLVM_ABI DWARFOperation {
  dwarf::LocationAtom Operator;
  std::vector<yaml::Hex64> Values;
};

struct LLVM_ABI RnglistEntry {
  dwarf::RnglistEntries Operator;
  std::vector<yaml::Hex64> Values;
};

struct LLVM_ABI LoclistEntry {
...
template <typename EntryType> struct LLVM_ABI ListEntries {
  std::optional<std::vector<EntryType>> Entries;
  std::optional<yaml::BinaryRef> Content;
};

template <typename EntryType> struct LLVM_ABI ListTable {
  dwarf::DwarfFormat Format;
  std::optional<yaml::Hex64> Length;
  yaml::Hex16 Version;
  std::optional<yaml::Hex8> AddrSize;
...
struct LLVM_ABI MappingTraits<DWARFYAML::ListTable<EntryType>> {
  static void mapping(IO &IO, DWARFYAML::ListTable<EntryType> &ListTable);
};

template <typename EntryType>
struct LLVM_ABI MappingTraits<DWARFYAML::ListEntries<EntryType>> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::DwarfFormat> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::Tag> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::LineNumberOps> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::LineNumberExtendedOps> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::Attribute> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::Form> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::UnitType> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::Constants> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::RnglistEntries> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::LoclistEntries> {
...
template <> struct LLVM_ABI ScalarEnumerationTraits<dwarf::LocationAtom> {
