...
struct LLVM_ABI AuxiliaryHeader {
...
struct LLVM_ABI FileAuxEnt : AuxSymbolEnt {
...
struct LLVM_ABI CsectAuxEnt : AuxSymbolEnt {
  // Only for XCOFF32.
...
struct LLVM_ABI FunctionAuxEnt : AuxSymbolEnt {
...
struct LLVM_ABI ExcpetionAuxEnt : AuxSymbolEnt {
...
struct LLVM_ABI BlockAuxEnt : AuxSymbolEnt {
  // Only for XCOFF32.
...
struct LLVM_ABI SectAuxEntForDWARF : AuxSymbolEnt {
...
struct LLVM_ABI SectAuxEntForStat : AuxSymbolEnt {
