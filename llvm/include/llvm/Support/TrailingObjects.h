...
/// objects.
template <typename First, typename... Rest> class LLVM_ABI AlignmentCalcHelper {
private:
  enum {
...
template <typename First> class LLVM_ABI AlignmentCalcHelper<First> {
public:
  enum { Alignment = alignof(First) };
};

/// The base class for TrailingObjects* classes.
class LLVM_ABI TrailingObjectsBase {
protected:
...
template <typename Ty1, typename Ty2> struct LLVM_ABI ExtractSecondType {
  typedef Ty2 type;
};
...
template <int Align, typename BaseTy, typename TopTrailingObj, typename PrevTy,
          typename... MoreTys>
class LLVM_ABI TrailingObjectsImpl {
...
class LLVM_ABI TrailingObjectsImpl<Align, BaseTy, TopTrailingObj, PrevTy, NextTy,
                          MoreTys...>
...
template <int Align, typename BaseTy, typename TopTrailingObj, typename PrevTy>
class LLVM_ABI alignas(Align) TrailingObjectsImpl<Align, BaseTy, TopTrailingObj, PrevTy>
...
class LLVM_ABI TrailingObjects : private trailing_objects_internal::TrailingObjectsImpl<
