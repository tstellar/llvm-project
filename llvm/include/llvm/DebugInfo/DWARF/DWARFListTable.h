...
/// entries.
struct LLVM_ABI DWARFListEntryBase {
...
template <typename ListEntryType> class LLVM_ABI DWARFListType {
...
template <typename DWARFListType> class LLVM_ABI DWARFListTableBase {
