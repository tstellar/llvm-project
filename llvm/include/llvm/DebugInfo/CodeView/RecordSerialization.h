...
template <typename T, typename U> struct LLVM_ABI serialize_conditional_impl {
...
template <typename T, typename U> struct LLVM_ABI serialize_array_impl {
...
template <typename T> struct LLVM_ABI serialize_vector_tail_impl {
...
struct LLVM_ABI serialize_null_term_string_array_impl {
...
template <typename T> struct LLVM_ABI serialize_arrayref_tail_impl {
...
template <typename T> struct LLVM_ABI serialize_numeric_impl {
