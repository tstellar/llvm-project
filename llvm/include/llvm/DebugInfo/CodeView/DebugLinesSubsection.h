...
struct LLVM_ABI LineFragmentHeader {
...
struct LLVM_ABI LineBlockFragmentHeader {
...
struct LLVM_ABI LineNumberEntry {
...
struct LLVM_ABI ColumnNumberEntry {
  support::ulittle16_t StartColumn;
  support::ulittle16_t EndColumn;
};

struct LLVM_ABI LineColumnEntry {
