...
[[noreturn]] LLVM_ABI void PrintFatalNote(ArrayRef<SMLoc> ErrorLoc, const Twine &Msg);
[[noreturn]] LLVM_ABI void PrintFatalNote(const Record *Rec, const Twine &Msg);
[[noreturn]] LLVM_ABI void PrintFatalNote(const RecordVal *RecVal, const Twine &Msg);
...
[[noreturn]] LLVM_ABI void PrintFatalError(ArrayRef<SMLoc> ErrorLoc, const Twine &Msg);
[[noreturn]] LLVM_ABI void PrintFatalError(const Record *Rec, const Twine &Msg);
[[noreturn]] LLVM_ABI void PrintFatalError(const RecordVal *RecVal, const Twine &Msg);

LLVM_ABI void CheckAssert(SMLoc Loc, Init *Condition, Init *Message);

LLVM_ABI extern SourceMgr SrcMgr;
LLVM_ABI extern unsigned ErrorsPrinted;
