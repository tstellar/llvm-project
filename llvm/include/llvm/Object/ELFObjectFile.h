...
class LLVM_ABI ELFSectionRef : public SectionRef {
public:
...
class LLVM_ABI elf_section_iterator : public section_iterator {
public:
...
class LLVM_ABI ELFSymbolRef : public SymbolRef {
public:
...
class LLVM_ABI elf_symbol_iterator : public symbol_iterator {
public:
...
class LLVM_ABI ELFRelocationRef : public RelocationRef {
public:
...
class LLVM_ABI elf_relocation_iterator : public relocation_iterator {
public:
...
template <class ELFT> class LLVM_ABI ELFObjectFile : public ELFObjectFileBase {
