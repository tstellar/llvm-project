...
template <endianness E, bool Is64> struct LLVM_ABI ELFType {
private:
...
struct LLVM_ABI Elf_Shdr_Base<ELFType<TargetEndianness, false>> {
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Shdr_Base<ELFType<TargetEndianness, true>> {
...
template <class ELFT>
struct LLVM_ABI Elf_Shdr_Impl : Elf_Shdr_Base<ELFT> {
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Sym_Base<ELFType<TargetEndianness, false>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Sym_Base<ELFType<TargetEndianness, true>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  Elf_Word st_name;       // Symbol name (index into string table)
  unsigned char st_info;  // Symbol's type and binding attributes
  unsigned char st_other; // Must be zero; reserved
...
template <class ELFT>
struct LLVM_ABI Elf_Sym_Impl : Elf_Sym_Base<ELFT> {
...
template <class ELFT>
struct LLVM_ABI Elf_Versym_Impl {
...
template <class ELFT>
struct LLVM_ABI Elf_Verdef_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
template <class ELFT>
struct LLVM_ABI Elf_Verdaux_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
template <class ELFT>
struct LLVM_ABI Elf_Verneed_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
/// section (.gnu.version_r). This structure is identical for ELF32 and ELF64.
template <class ELFT>
struct LLVM_ABI Elf_Vernaux_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Dyn_Base<ELFType<TargetEndianness, false>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
  Elf_Sword d_tag;
  union {
    Elf_Word d_val;
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Dyn_Base<ELFType<TargetEndianness, true>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  Elf_Sxword d_tag;
  union {
    Elf_Xword d_val;
...
template <class ELFT>
struct LLVM_ABI Elf_Dyn_Impl : Elf_Dyn_Base<ELFT> {
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Rel_Impl<ELFType<TargetEndianness, false>, false> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Rel_Impl<ELFType<TargetEndianness, false>, true>
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Rel_Impl<ELFType<TargetEndianness, true>, false> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  static const bool IsRela = false;
  Elf_Addr r_offset; // Location (file byte offset, or program virtual addr)
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Rel_Impl<ELFType<TargetEndianness, true>, true>
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Phdr_Impl<ELFType<TargetEndianness, false>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Phdr_Impl<ELFType<TargetEndianness, true>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  Elf_Word p_type;    // Type of segment
  Elf_Word p_flags;   // Segment flags
  Elf_Off p_offset;   // FileOffset where segment is located, in bytes
...
// .gnu.hash section
template <class ELFT>
struct LLVM_ABI Elf_GnuHash_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
  Elf_Word nbuckets;
  Elf_Word symndx;
  Elf_Word maskwords;
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Chdr_Impl<ELFType<TargetEndianness, false>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
  Elf_Word ch_type;
  Elf_Word ch_size;
...
template <endianness TargetEndianness>
struct LLVM_ABI Elf_Chdr_Impl<ELFType<TargetEndianness, true>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  Elf_Word ch_type;
...
template <class ELFT> class LLVM_ABI Elf_Note_Iterator_Impl {
public:
...
template <class ELFT> struct LLVM_ABI Elf_CGProfile_Impl {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
struct LLVM_ABI Elf_Mips_RegInfo<ELFType<TargetEndianness, false>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, false)
...
template <support::endianness TargetEndianness>
struct LLVM_ABI Elf_Mips_RegInfo<ELFType<TargetEndianness, true>> {
  LLVM_ELF_IMPORT_TYPES(TargetEndianness, true)
  Elf_Word ri_gprmask;     // bit-mask of used general registers
...
template <class ELFT> struct LLVM_ABI Elf_Mips_Options {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
...
template <class ELFT> struct LLVM_ABI Elf_Mips_ABIFlags {
  LLVM_ELF_IMPORT_TYPES_ELFT(ELFT)
