...
LLVM_ABI std::string mangleTLIVectorName(StringRef VectorName, StringRef ScalarName,
...
template <typename InstTy> class LLVM_ABI InterleaveGroup {
public:
