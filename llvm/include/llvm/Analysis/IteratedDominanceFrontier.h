...
template <bool IsPostDom> struct LLVM_ABI ChildrenGetterTy<BasicBlock, IsPostDom> {
...
class LLVM_ABI IDFCalculator final : public IDFCalculatorBase<BasicBlock, IsPostDom> {
public:
