...
LLVM_ABI void computeKnownBitsFromAssume(const Value *V, KnownBits &Known,
...
LLVM_ABI bool haveNoCommonBitsSet(const Value *LHS, const Value *RHS,
...
LLVM_ABI bool isKnownNonNegative(const Value *V, const DataLayout &DL,
                        unsigned Depth = 0, AssumptionCache *AC = nullptr,
                        const Instruction *CxtI = nullptr,
                        const DominatorTree *DT = nullptr,
                        bool UseInstrInfo = true);
...
/// and non-zero).
LLVM_ABI bool isKnownPositive(const Value *V, const DataLayout &DL, unsigned Depth = 0,
                     AssumptionCache *AC = nullptr,
                     const Instruction *CxtI = nullptr,
                     const DominatorTree *DT = nullptr,
                     bool UseInstrInfo = true);
...
/// and non-zero).
LLVM_ABI bool isKnownNegative(const Value *V, const DataLayout &DL, unsigned Depth = 0,
                     AssumptionCache *AC = nullptr,
                     const Instruction *CxtI = nullptr,
                     const DominatorTree *DT = nullptr,
                     bool UseInstrInfo = true);
...
/// same width as the vector element, and the bit is set only if it is true
/// for all of the elements in the vector.
LLVM_ABI bool MaskedValueIsZero(const Value *V, const APInt &Mask, const DataLayout &DL,
                       unsigned Depth = 0, AssumptionCache *AC = nullptr,
                       const Instruction *CxtI = nullptr,
                       const DominatorTree *DT = nullptr,
                       bool UseInstrInfo = true);
...
/// -0.0.
LLVM_ABI bool CannotBeNegativeZero(const Value *V, const TargetLibraryInfo *TLI,
                          unsigned Depth = 0);


LLVM_ABI bool CannotBeOrderedLessThanZero(const Value *V, const DataLayout &DL,
                                 const TargetLibraryInfo *TLI);
...
struct LLVM_ABI ConstantDataArraySlice {
...
LLVM_ABI OverflowResult computeOverflowForSignedMul(const Value *LHS, const Value *RHS,
                                           ...
                                           const DominatorTree *DT,
                                           bool UseInstrInfo = true);
LLVM_ABI OverflowResult computeOverflowForUnsignedAdd(const Value *LHS, const Value *RHS,
                                             const DataLayout &DL,
                                             AssumptionCache *AC,
                                             const Instruction *CxtI,
                                             const DominatorTree *DT,
                                             bool UseInstrInfo = true);
LLVM_ABI OverflowResult computeOverflowForSignedAdd(const Value *LHS, const Value *RHS,
                                           const DataLayout &DL,
                                           AssumptionCache *AC = nullptr,
                                           const Instruction *CxtI = nullptr,
                                           const DominatorTree *DT = nullptr);
...
struct LLVM_ABI SelectPatternResult {
