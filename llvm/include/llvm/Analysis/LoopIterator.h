...
struct LLVM_ABI LoopBodyTraits {
...
template<> class LLVM_ABI po_iterator_storage<LoopBlocksTraversal, true> {
...
class LLVM_ABI LoopBlocksTraversal {
public:
