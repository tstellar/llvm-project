...
struct LLVM_ABI AllAccessTag {};
struct LLVM_ABI DefsOnlyTag {};
...
template <>
struct LLVM_ABI ilist_alloc_traits<MemoryAccess> {
...
/// MemoryDef instead.
class LLVM_ABI MemoryUseOrDef : public MemoryAccess {
public:
  void *operator new(size_t) = delete;
...
template <>
struct LLVM_ABI OperandTraits<MemoryUse> : public FixedNumOperandTraits<MemoryUse, 1> {};
...
template <>
struct LLVM_ABI OperandTraits<MemoryDef> : public FixedNumOperandTraits<MemoryDef, 2> {};
DEFINE_TRANSPARENT_OPERAND_ACCESSORS(MemoryDef, MemoryAccess)

template <>
struct LLVM_ABI OperandTraits<MemoryUseOrDef> {
...
template <> struct LLVM_ABI OperandTraits<MemoryPhi> : public HungoffOperandTraits<2> {};
...
template <class T>
class LLVM_ABI memoryaccess_def_iterator_base
...
template <> struct LLVM_ABI GraphTraits<MemoryAccess *> {
...
template <> struct LLVM_ABI GraphTraits<Inverse<MemoryAccess *>> {
  using NodeRef = MemoryAccess *;
...
struct LLVM_ABI def_chain_iterator
