...
template<> struct LLVM_ABI DenseMapInfo<Attribute::AttrKind> {
...
///  - WasOn will be %P.
///  - ArgValue will be 4.
struct LLVM_ABI RetainedKnowledge {
...
LLVM_ABI bool isAssumeWithEmptyBundle(AssumeInst &Assume);
