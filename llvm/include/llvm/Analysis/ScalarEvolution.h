...
template <> struct LLVM_ABI FoldingSetTrait<SCEV> : DefaultFoldingSetTrait<SCEV> {
...
// temporary FoldingSetNodeID values.
template <>
struct LLVM_ABI FoldingSetTrait<SCEVPredicate> : DefaultFoldingSetTrait<SCEVPredicate> {
...
template <> struct LLVM_ABI DenseMapInfo<ScalarEvolution::FoldID> {
