...
template <class LatticeKey> struct LLVM_ABI LatticeKeyInfo {
...
template <class LatticeKey, class LatticeVal> class LLVM_ABI AbstractLatticeFunction {
private:
