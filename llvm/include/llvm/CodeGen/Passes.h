...
namespace llvm {
  ...
  LLVM_ABI FunctionPass *createCodeGenPreparePass();
  ...
  ///
  LLVM_ABI FunctionPass *createGCInfoPrinter(raw_ostream &OS);
  ...
  LLVM_ABI FunctionPass *createDwarfEHPass(CodeGenOpt::Level OptLevel);
  ...
  LLVM_ABI ModulePass *createJumpInstrTablesPass();
  ...
  LLVM_ABI FunctionPass *createExpandMemCmpPass();
  ...
  LLVM_ABI FunctionPass *createX86PreAMXConfigPass();
