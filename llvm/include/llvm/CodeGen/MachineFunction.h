...
struct LLVM_ABI LandingPadInfo {
...
//
template <> struct LLVM_ABI GraphTraits<MachineFunction*> :
...
template <> struct LLVM_ABI GraphTraits<const MachineFunction*> :
...
//
template <> struct LLVM_ABI GraphTraits<Inverse<MachineFunction*>> :
  public GraphTraits<Inverse<MachineBasicBlock*>> {
  static NodeRef getEntryNode(Inverse<MachineFunction *> G) {
    return &G.Graph->front();
  }
};
template <> struct LLVM_ABI GraphTraits<Inverse<const MachineFunction*>> :
