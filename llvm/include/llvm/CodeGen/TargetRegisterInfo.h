...
class LLVM_ABI TargetRegisterClass {
public:
...
struct LLVM_ABI TargetRegisterInfoDesc {
...
struct LLVM_ABI RegClassWeight {
  unsigned RegWeight;
...
//
class LLVM_ABI SuperRegClassIterator {
...
class LLVM_ABI BitMaskClassIterator {
...
struct LLVM_ABI VirtReg2IndexFunctor {
