...
class LLVM_ABI DOTMachineFuncInfo {
private:
...
template <>
struct LLVM_ABI GraphTraits<DOTMachineFuncInfo *>
...
template <>
struct LLVM_ABI DOTGraphTraits<DOTMachineFuncInfo *> : public DefaultDOTGraphTraits {
