...
/// hashing names.
template <typename DataT> class LLVM_ABI AccelTable : public AccelTableBase {
public:
...
class LLVM_ABI DWARF5AccelTableStaticData : public AccelTableData {
public:
  static uint32_t hash(StringRef Name) { return caseFoldingDjbHash(Name); }
...
LLVM_ABI void emitDWARF5AccelTable(AsmPrinter *Asm,
