...
struct LLVM_ABI CxxUnwindMapEntry {
  int ToState;
  MBBOrBasicBlock Cleanup;
};

/// Similar to CxxUnwindMapEntry, but supports SEH filters.
struct LLVM_ABI SEHUnwindMapEntry {
...
struct LLVM_ABI WinEHHandlerType {
  int Adjectives;
...
struct LLVM_ABI WinEHTryBlockMapEntry {
  int TryLow = -1;
  int TryHigh = -1;
  int CatchHigh = -1;
...
struct LLVM_ABI ClrEHUnwindMapEntry {
  MBBOrBasicBlock Handler;
  uint32_t TypeToken;
