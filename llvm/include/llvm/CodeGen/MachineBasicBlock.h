...
struct LLVM_ABI MBB2NumberFunctor {
...
template <> struct LLVM_ABI GraphTraits<MachineBasicBlock *> {
...
template <> struct LLVM_ABI GraphTraits<const MachineBasicBlock *> {
...
//
template <> struct LLVM_ABI GraphTraits<Inverse<MachineBasicBlock*>> {
  using NodeRef = MachineBasicBlock *;
...
template <> struct LLVM_ABI GraphTraits<Inverse<const MachineBasicBlock*>> {
  using NodeRef = const MachineBasicBlock *;
...
class LLVM_ABI MachineInstrSpan {
