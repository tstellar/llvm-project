...
struct LLVM_ABI IntrusiveBackListNode {
...
struct LLVM_ABI IntrusiveBackListBase {
...
template <class T> class LLVM_ABI IntrusiveBackList : IntrusiveBackListBase {
public:
...
struct LLVM_ABI BasicDIEUnit final : DIEUnit {
