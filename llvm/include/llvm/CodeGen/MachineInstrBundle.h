...
class LLVM_ABI MIBundleOperandIteratorBase
...
/// instructions.
///
class LLVM_ABI MIBundleOperands : public MIBundleOperandIteratorBase<MachineOperand> {
...
///
class LLVM_ABI ConstMIBundleOperands
