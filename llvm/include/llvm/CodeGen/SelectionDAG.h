...
class LLVM_ABI SDVTListNode : public FoldingSetNode {
...
template<> struct LLVM_ABI FoldingSetTrait<SDVTListNode> : DefaultFoldingSetTrait<SDVTListNode> {
...
template <> struct LLVM_ABI ilist_alloc_traits<SDNode> {
...
template <> struct LLVM_ABI GraphTraits<SelectionDAG*> : public GraphTraits<SDNode*> {
