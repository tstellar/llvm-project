 ...
 */
LLVM_ABI LLVMComdatRef LLVMGetOrInsertComdat(LLVMModuleRef M, const char *Name);
 ...
 */
LLVM_ABI LLVMComdatRef LLVMGetComdat(LLVMValueRef V);
 ...
 */
LLVM_ABI void LLVMSetComdat(LLVMValueRef V, LLVMComdatRef C);
 ...
 */
LLVM_ABI LLVMComdatSelectionKind LLVMGetComdatSelectionKind(LLVMComdatRef C);
 ...
 */
LLVM_ABI void LLVMSetComdatSelectionKind(LLVMComdatRef C, LLVMComdatSelectionKind Kind);
