 ...
 */
LLVM_ABI unsigned LLVMDebugMetadataVersion(void);

/**
 * The version of debug metadata that's present in the provided \c Module.
 */
LLVM_ABI unsigned LLVMGetModuleDebugMetadataVersion(LLVMModuleRef Module);
 ...
 */
LLVM_ABI LLVMBool LLVMStripModuleDebugInfo(LLVMModuleRef Module);

/**
 * Construct a builder for a module, and do not allow for unresolved nodes
 * attached to the module.
 */
LLVM_ABI LLVMDIBuilderRef LLVMCreateDIBuilderDisallowUnresolved(LLVMModuleRef M);
 ...
 */
LLVM_ABI LLVMDIBuilderRef LLVMCreateDIBuilder(LLVMModuleRef M);

/**
 * Deallocates the \c DIBuilder and everything it owns.
 * @note You must call \c LLVMDIBuilderFinalize before this
 */
LLVM_ABI void LLVMDisposeDIBuilder(LLVMDIBuilderRef Builder);

/**
 * Construct any deferred debug info descriptors.
 */
LLVM_ABI void LLVMDIBuilderFinalize(LLVMDIBuilderRef Builder);

/**
 * Finalize a specific subprogram.
 * No new variables may be added to this subprogram afterwards.
 */
LLVM_ABI void LLVMDIBuilderFinalizeSubprogram(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateCompileUnit(
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateFunction(
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateLexicalBlock(
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateImportedModuleFromAlias(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope,
 ...
 * \param NumElements    Number of renamed elements.
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateImportedModuleFromModule(
 ...
 * \param NumElements    Number of renamed elements.
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateImportedDeclaration(
 ...
 */
LLVM_ABI unsigned LLVMDILocationGetLine(LLVMMetadataRef Location);
 ...
 */
LLVM_ABI unsigned LLVMDILocationGetColumn(LLVMMetadataRef Location);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDILocationGetScope(LLVMMetadataRef Location);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDILocationGetInlinedAt(LLVMMetadataRef Location);
 ...
 * @see DIScope::getFile()
 */
LLVM_ABI LLVMMetadataRef LLVMDIScopeGetFile(LLVMMetadataRef Scope);
 ...
 */
LLVM_ABI const char *LLVMDIFileGetDirectory(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_ABI const char *LLVMDIFileGetFilename(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_ABI const char *LLVMDIFileGetSource(LLVMMetadataRef File, unsigned *Len);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderGetOrCreateTypeArray(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateMacro(LLVMDIBuilderRef Builder,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateEnumerator(LLVMDIBuilderRef Builder,
                                              const char *Name, size_t NameLen,
                                              int64_t Value,
                                              LLVMBool IsUnsigned);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateEnumerationType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateUnionType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
    size_t NameLen, LLVMMetadataRef File, unsigned LineNumber,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreatePointerType(
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateStructType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
    size_t NameLen, LLVMMetadataRef File, unsigned LineNumber,
    uint64_t SizeInBits, uint32_t AlignInBits, LLVMDIFlags Flags,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateMemberType(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateForwardDecl(
 ...
 * \param UniqueIdentifierLen Length of the unique identifier.
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateClassType(LLVMDIBuilderRef Builder,
 ...
 * @see DIType::getName()
 */
LLVM_ABI const char *LLVMDITypeGetName(LLVMMetadataRef DType, size_t *Length);
 ...
 */
LLVM_ABI uint64_t LLVMDITypeGetSizeInBits(LLVMMetadataRef DType);
 ...
 */
LLVM_ABI uint64_t LLVMDITypeGetOffsetInBits(LLVMMetadataRef DType);
 ...
 */
LLVM_ABI uint32_t LLVMDITypeGetAlignInBits(LLVMMetadataRef DType);
 ...
 * @see DIType::getLine()
 */
LLVM_ABI unsigned LLVMDITypeGetLine(LLVMMetadataRef DType);
 ...
 * @see DIType::getFlags()
 */
LLVM_ABI LLVMDIFlags LLVMDITypeGetFlags(LLVMMetadataRef DType);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderGetOrCreateSubrange(LLVMDIBuilderRef Builder,
                                                 int64_t LowerBound,
                                                 int64_t Count);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderGetOrCreateArray(LLVMDIBuilderRef Builder,
                                              LLVMMetadataRef *Data,
                                              size_t NumElements);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateExpression(LLVMDIBuilderRef Builder,
 ...
 *                    specified)
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateGlobalVariableExpression(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_ABI uint16_t LLVMGetDINodeTag(LLVMMetadataRef MD);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIGlobalVariableExpressionGetVariable(LLVMMetadataRef GVE);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIGlobalVariableExpressionGetExpression(
    LLVMMetadataRef GVE);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIVariableGetFile(LLVMMetadataRef Var);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIVariableGetScope(LLVMMetadataRef Var);
 ...
 */
LLVM_ABI unsigned LLVMDIVariableGetLine(LLVMMetadataRef Var);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMTemporaryMDNode(LLVMContextRef Ctx, LLVMMetadataRef *Data,
                                    size_t NumElements);
 ...
 */
LLVM_ABI void LLVMDisposeTemporaryMDNode(LLVMMetadataRef TempNode);
 ...
 */
LLVM_ABI void LLVMMetadataReplaceAllUsesWith(LLVMMetadataRef TempTargetMetadata,
 ...
 *                    specified)
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateTempGlobalVariableFwdDecl(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_ABI LLVMValueRef LLVMDIBuilderInsertDeclareBefore(
 ...
 */
LLVM_ABI LLVMValueRef LLVMDIBuilderInsertDeclareAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueBefore(LLVMDIBuilderRef Builder,
                                               LLVMValueRef Val,
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueAtEnd(LLVMDIBuilderRef Builder,
                                              LLVMValueRef Val,
                                              LLVMMetadataRef VarInfo,
                                              LLVMMetadataRef Expr,
                                              LLVMMetadataRef DebugLoc,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateAutoVariable(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 * \param Flags           Flags.
 */
LLVM_ABI LLVMMetadataRef LLVMDIBuilderCreateParameterVariable(
    LLVMDIBuilderRef Builder, LLVMMetadataRef Scope, const char *Name,
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMGetSubprogram(LLVMValueRef Func);
 ...
 */
LLVM_ABI void LLVMSetSubprogram(LLVMValueRef Func, LLVMMetadataRef SP);
 ...
 */
LLVM_ABI unsigned LLVMDISubprogramGetLine(LLVMMetadataRef Subprogram);
 ...
 */
LLVM_ABI LLVMMetadataRef LLVMInstructionGetDebugLoc(LLVMValueRef Inst);
 ...
 */
LLVM_ABI void LLVMInstructionSetDebugLoc(LLVMValueRef Inst, LLVMMetadataRef Loc);
 ...
 */
LLVM_ABI LLVMMetadataKind LLVMGetMetadataKind(LLVMMetadataRef Metadata);
