 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern const char *LLVMRemarkStringGetData(LLVMRemarkStringRef String);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint32_t LLVMRemarkStringGetLen(LLVMRemarkStringRef String);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkStringRef
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint32_t LLVMRemarkDebugLocGetSourceLine(LLVMRemarkDebugLocRef DL);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint32_t LLVMRemarkDebugLocGetSourceColumn(LLVMRemarkDebugLocRef DL);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkStringRef LLVMRemarkArgGetKey(LLVMRemarkArgRef Arg);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkStringRef LLVMRemarkArgGetValue(LLVMRemarkArgRef Arg);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkDebugLocRef LLVMRemarkArgGetDebugLoc(LLVMRemarkArgRef Arg);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern void LLVMRemarkEntryDispose(LLVMRemarkEntryRef Remark);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern enum LLVMRemarkType LLVMRemarkEntryGetType(LLVMRemarkEntryRef Remark);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkDebugLocRef
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint64_t LLVMRemarkEntryGetHotness(LLVMRemarkEntryRef Remark);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint32_t LLVMRemarkEntryGetNumArgs(LLVMRemarkEntryRef Remark);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkArgRef LLVMRemarkEntryGetFirstArg(LLVMRemarkEntryRef Remark);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkArgRef LLVMRemarkEntryGetNextArg(LLVMRemarkArgRef It,
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkParserRef LLVMRemarkParserCreateYAML(const void *Buf,
                                                      uint64_t Size);
 ...
 */
LLVM_ABI extern LLVMRemarkParserRef LLVMRemarkParserCreateBitstream(const void *Buf,
                                                           uint64_t Size);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMRemarkEntryRef LLVMRemarkParserGetNext(LLVMRemarkParserRef Parser);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern LLVMBool LLVMRemarkParserHasError(LLVMRemarkParserRef Parser);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern const char *LLVMRemarkParserGetErrorMessage(LLVMRemarkParserRef Parser);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern void LLVMRemarkParserDispose(LLVMRemarkParserRef Parser);
 ...
 * \since REMARKS_API_VERSION=0
 */
LLVM_ABI extern uint32_t LLVMRemarkVersion(void);
